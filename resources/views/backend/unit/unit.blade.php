    ...
    <div class="lg:flex intro-y mt-5 mb-5">
        ...
        <div class="relative">
            <input type="text" name="keyword" id="keyword" class="form-control py-3 px-4 w-full lg:w-64 box pr-10"
                placeholder="ชื่อ{{ $default_pagename }}..." value="{{ request()->input('keyword') }}" onkeypress="handleEnter(event)">
            ...
            <table class="table table-report -mt-2">
                <thead>
                    <tr>
                        ...
                        <th class="whitespace-nowrap">ชื่อหน่วนนับ</th>
                        ...
                        <tr class="intro-x">
                            ...
                            <td class="table-report__action w-56">
                                <div class="flex justify-center items-center">
                                    <a class="flex items-center" href="{{ route('unit_edit', ['id' => $res->id]) }}">
...
@section('script')
    <script>
        function applyFilters() {
            ...
            var newUrl = `{{ route('unit') }}?keyword=${keyword}`;
